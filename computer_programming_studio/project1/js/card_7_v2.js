$(document).ready(function(){
  ...
  $("#c").on("click", function(){
    $("#next").css("animation","cd 6s infinite")
    ...
    $("#c").css("left","18%")
    $("#c").css("color","white")
    $("#o").css("animation","move2 8s ease-in-out")
    $("#o").css("left","28%")
    $("#o").css("top","45%")
    $("#o").css("color","white")
    $("#u").css("animation","move3 8s ease-in-out")
    $("#u").css("left","38%")
    $("#u").css("top","45%")
    $("#u").css("color","white")
    $("#r").css("animation","move4 8s ease-in-out")
    $("#r").css("left","48%")
    $("#r").css("top","45%")
    $("#r").css("color","white")
    $("#a").css("animation","move5 8s ease-in-out")
    $("#a").css("left","58%")
    $("#a").css("top","45%")
    $("#a").css("color","white")
    $("#g").css("animation","move6 8s ease-in-out")
    $("#g").css("left","68%")
    $("#g").css("top","45%")
    $("#g").css("color","white")
    $("#e").css("animation","move7 8s ease-in-out")
    $("#e").css("left","78%")
    $("#e").css("top","45%")
    $("#e").css("color","white")
